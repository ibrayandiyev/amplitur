        ...
        <table class="table">
            <tr>
                <td class="td_padding">
                    ...
                    <p>{{__('mail.geral.hi')}}
                        PASTA BOOKING - BOOKING (RODRIGO - NOME DO CLIENTE AQUI)</p>
                    ...
                    <ul>
                        <li style="text-align: justify;" >{{__('mail.client.booking.keep_track')}} {{__('mail.client.booking.my_account')}}</li>
                    </ul>
                    ...
                    <span style="font-size: 18px;"><b>{{__('mail.client.booking.head_docs')}}</b></span>
                        ...
                        <ul>
                            <li style="text-align: justify;" >{{__('mail.client.booking.label_contract')}}</li>
