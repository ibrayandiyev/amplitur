                ...
                <table class="table">
                    <tr>
                        <td class="td_padding">
                            ...
                            <P><BR><span class="link">{{__('mail.provider.comun.update')}}</span></P>

                            <p>{{__('mail.geral.hi')}} {{ $provider->name }}</p>

                            <p>{{__('mail.provider.comun.update_msg')}}</p>

                            <CENTER>
                                <span class="book"><b>{{__('mail.provider.comun.booking_code')}}</b> <strong style="color: #27880e;">{{ $booking->id }}</strong></span>
                                <BR><BR><strong style="color: #13456e;">{{ $booking->getName() }}</strong>
                            </CENTER>

                            <p>{{__('mail.provider.comun.msg_click')}}</p>

                            <CENTER>
                                <a href="{{ route('backend.bookings.edit', $booking) }}">
                                    <span class="link"><b>{{__('mail.provider.comun.purchase_acess')}}</b></span>
                                </a>
                            </CENTER>
