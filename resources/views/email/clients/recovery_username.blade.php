                ...
                <table class="table">
                    <tr>
                        <td class="td_padding">
                            ...
                            <P><BR><span class="link">{{__('mail.client.recov_user.head')}}</span></P>

                            <p>{{__('mail.geral.hi')}} {{ $client->name}}</p>

                            <p>{{__('mail.client.recov_user.recov_msg')}}</p>

                            <li><b>{{__('mail.client.recov_user.recov_login')}}: </b>{{ $client->username}}</li>

                            <p>{{__('mail.client.recov_user.end_msg')}}</p>
