                ...
                <table class="table">
                    <tr>
                        <td class="td_padding">
                            ...
                            <P><BR><span class="link">{{__('mail.client.recov_pass.head_confirm')}}</span></P>

                            <p>{{__('mail.geral.hi')}} {{ $client->name }}</p>

                            <p>{{__('mail.client.recov_pass.recov_msg_confirm')}} <BR> Login: <strong> {{ $client->username}} </strong> </p>

                            <p>{{__('mail.client.recov_pass.recov_pass_confirm')}}</p>
