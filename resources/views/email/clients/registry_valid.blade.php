                ...
                <table class="table">
                    <tr>
                        <td class="td_padding">
                            ...
                            <p><BR><span class="head-1">{{__('mail.client.valid_registry.head')}}</span></p>
                            ...
                            <p>{{__('mail.client.valid_registry.head_msg')}}</p>

                            <p>{{__('mail.client.valid_registry.link_msg')}}</p>
                            <CENTER>
                                <span class="link">
                                    <a href="{{route('frontend.index')}}" target="_blank">
                                    {{__('mail.client.valid_registry.link_acess')}}</a>
                                </span><BR><BR>

                            </CENTER>

                            <p>{{__('mail.client.valid_registry.doubt_msg')}}</p>
