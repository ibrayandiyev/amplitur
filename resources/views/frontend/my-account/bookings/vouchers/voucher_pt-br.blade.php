...
<div class="grupo corpo-doc">
	...
	<div class="titulo-grande grid2-1 ultima">
		<h1>Voucher Digital Nº {{ $booking->id }}</h1>
	</div>
</div>
...
<div id="corpo-doc">
	...
	<p class="box">
		Favor verificar todos os serviços que estão descritos abaixo para que não haja problemas no momento de sua prestação. Em caso de divergência favor entrar em contato URGENTE com a Agência de Turismo vendedora do pacote ou diretamente com a AMP Travels Ltd.
	</p>
