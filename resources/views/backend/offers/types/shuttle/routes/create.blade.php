...
<div class="row page-titles">
    <div class="col-md-12">
        <h3 class="text-themecolor">{{ __('resources.shuttle-routes.create') }}</h3>
        <ol class="breadcrumb">
...
<form id="shuttleRouteForm" method="post" action="{{ route('backend.providers.companies.offers.shuttle.storeRoute', [$provider, $company, $offer]) }}" autocomplete="off">
    @csrf
    <div class="card">
        <div class="labelx label-service">
            {{ __('resources.shuttle-routes.info') }}
        </div>
