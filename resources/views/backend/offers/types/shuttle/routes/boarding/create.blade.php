...
<div class="row page-titles">
    <div class="col-md-12">
        <h3 class="text-themecolor">{{ __('resources.shuttle-routes-boarding.create') }}</h3>
        <ol class="breadcrumb">
...
<form id="shuttleBoardingLocationForm" method="post" action="{{ route('backend.providers.companies.offers.shuttle.storeBoardingLocation', [$provider, $company, $offer, $shuttleRoute]) }}" autocomplete="off">
    @csrf
    ...
    <div class="card">
        <div class="labelx label-service">
            {{ __('resources.shuttle-routes-boarding.info') }}
        </div>
