...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form id="additionalGroupsForm" method="post" action="{{ route('backend.providers.companies.offers.airfare.updateGroup', [$provider, $company, $offer, $additionalGroup]) }}" autocomplete="off">
