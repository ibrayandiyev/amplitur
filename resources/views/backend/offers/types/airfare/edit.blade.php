                        ...
                        <div class="row">
                            <div class="col-md-12">
                                @if (count($additionalGroups) > 0)
                                    <a href="{{ route('backend.providers.companies.offers.airfare.createItem', [$provider, $company, $offer]) }}" class="btn btn-sm btn-primary">
                                        <i class="fa fa-plus"></i>
                                        {{ __('messages.add-item') }}
                                    </a>
                                @endif
                                <a href="{{ route('backend.providers.companies.offers.airfare.createGroup', [$provider, $company, $offer]) }}" class="btn btn-sm btn-secondary">
                                    <i class="fa fa-plus"></i>
                            ...
                            <div class="col-md-12 m-t-10 grouped-entities">
                                @include('backend.offers.types.airfare.items.table')
                            </div>
                        </div>
                    </div>
