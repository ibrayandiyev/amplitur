...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form id="additionalsForm" method="post" action="{{ route('backend.providers.companies.offers.airfare.updateItem', [$provider, $company, $offer, $additionalItem]) }}" autocomplete="off">
