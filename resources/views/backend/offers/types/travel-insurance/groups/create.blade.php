...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form id="additionalGroupsForm" method="post" action="{{ route('backend.providers.companies.offers.travel-insurance.storeGroup', [$provider, $company, $offer]) }}" autocomplete="off">
