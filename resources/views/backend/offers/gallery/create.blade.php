...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form id="imagesForm" method="post" action="{{ route('backend.providers.companies.offers.gallery.store', [$provider, $company, $offer]) }}" enctype="multipart/form-data" autocomplete="off">
                @csrf
