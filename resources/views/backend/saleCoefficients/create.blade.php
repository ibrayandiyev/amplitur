...
<div class="row page-titles">
    <div class="col-md-5">
        <h3 class="text-themecolor">{{ __('resources.saleCoefficients.create') }}</h3>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ __('resources.saleCoefficients.create') }}</li>
        </ol>
    </div>
    <div class="col-md-7">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form id="saleCoefficientForm" method="post" action="{{ route('backend.saleCoefficients.store') }}" autocomplete="off">
                @csrf
                    ...
                    <div class="tab-pane active" id="basic-info" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 @if($errors->has('value')) has-danger @endif">
                                ...
                                <input type="number" step="0.00001" class="form-control" name="value" value="{{ old('value', '1.00000') }}" placeholder="1,00000">
                            </div>
                            <div class="form-group col-md-3">
                                ...
                                <select class="form-control text-uppercase" name="is_default">
                                    <option value="0" @if (old('is_default') == 0) selected @endif>{{ __('messages.no') }}</option>
                                    <option value="1" @if (old('is_default') == 1) selected @endif>{{ __('messages.yes') }}</option>
                                </select>
                            </div>
                        </div>
                    </div>
