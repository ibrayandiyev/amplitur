<table id="filter" class="table color-bordered-table warning-bordered-table">
    ...
    <tr>
        <td>
            <form method="GET" action="{{ route('backend.reports.report_detail_booking.index') }}" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select name="provider_id" id="provider_id" class="form-control ">
                                <option data-json="[]" value="-1">{{ __("report.select_option")}}</option>
...
@push('scripts')
    <script type="text/javascript">
        ...
        function changeProvider(stringJson){
            ...
            $('<option>').val(-1).text("{{ __('report.select_option')}}").appendTo($select);
