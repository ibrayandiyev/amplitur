...
<div class="row page-titles">
    <div class="col-md-5">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ __('resources.events.create') }}</li>
        </ol>
    </div>
    <div class="col-md-7">
                            ...
                            <div class="form-group col-md-12 @if($errors->has('description')) has-danger @endif">
                                ...
                                <div class="tab-content br-n pn">
                                    <div id="seo-description-pt-br" class="tab-pane active">
                                        <textarea class="form-control summernote" name="description[pt-br]" rows="8">{!! old('description.pt-br') !!}</textarea>
                                    </div>
                                    <div id="seo-description-en" class="tab-pane">
                                        <textarea class="form-control summernote" name="description[en]" rows="8">{!! old('description.en') !!}</textarea>
                                    </div>
                                    <div id="seo-description-es" class="tab-pane">
                                        <textarea class="form-control summernote" name="description[es]" rows="8">{!! old('description.es') !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="tab-content br-n pn">
                                    <div id="seo-meta-keywords-pt-br" class="tab-pane active">
                                        <div class="tags-default">
                                            <input type="text" name="meta_keywords[pt-br]" class="form-control" data-role="tagsinput" value="{{ old('meta_keywords.pt-br') }}"/>
                                    ...
                                    <div id="seo-meta-keywords-en" class="tab-pane">
                                        <div class="tags-default">
                                            <input type="text" name="meta_keywords[en]" class="form-control" data-role="tagsinput" value="{{ old('meta_keywords.en') }}"/>
                                            <span class="help-block">
                                                <small>{{ __('resources.events.hints.keywords') }}</small>
                                            </span>
                                        </div>
                                    ...
                                    <div id="seo-meta-keywords-es" class="tab-pane">
                                        <div class="tags-default">
                                            <input type="text" name="meta_keywords[es]" class="form-control" data-role="tagsinput" value="{{ old('meta_keywords.es') }}"/>
                                            <span class="help-block">
                                                <small>{{ __('resources.events.hints.keywords') }}</small>
                                            </span>
                                        </div>
                            ...
                            <div class="form-group col-md-12 @if($errors->has('meta_description')) has-danger @endif">
                                ...
                                <div class="tab-content br-n pn">
                                    <div id="seo-meta-description-pt-br" class="tab-pane active">
                                        <textarea name="meta_description[pt-br]" class="form-control" rows="5">{{ old('meta_description.pt-br') }}</textarea>
                                    </div>
                                    <div id="seo-meta-description-en" class="tab-pane">
                                        <textarea name="meta_description[en]" class="form-control" rows="5">{{ old('meta_description.en') }}</textarea>
                                    </div>
                                    <div id="seo-meta-description-es" class="tab-pane">
                                        <textarea name="meta_description[es]" class="form-control" rows="5">{{ old('meta_description.es') }}</textarea>
                                    </div>
                                </div>
                                <ul class="nav nav-pills m-b-30 m-t-10">
