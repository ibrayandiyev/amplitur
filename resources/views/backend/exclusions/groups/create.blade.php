...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form id="exclusionGroupsForm" method="post" action="{{ route('backend.exclusions.groups.store', ['type' => $type]) }}" autocomplete="off">
                @csrf
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('backend.exclusions.groups.index', ['type' => $type]) }}" class="btn btn-secondary">
