...
<div class="row page-titles">
    <div class="col-md-8">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('backend.exclusions.index', ['type' => 'bustrip']) }}">{{ __('resources.exclusions.name-plural') }}</a>
            </li>
            <li class="breadcrumb-item active">{{ __('resources.exclusions.create') }}</li>
        </ol>
    </div>
    <div class="col-md-4">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form id="clientForm" method="post" action="{{ route('backend.exclusions.store', ['type' => $type]) }}" autocomplete="off">
                @csrf
                ...
                <div class="card-body row">
                    ...
                    <div class="form-group col-md-3">
                        <label class="form-control-label">{{ __('resources.exclusive') }}</label>
                        <span class="text-danger">*</span>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('backend.exclusions.index', ['type' => \App\Enums\OfferType::BUSTRIP]) }}" class="btn btn-secondary">
