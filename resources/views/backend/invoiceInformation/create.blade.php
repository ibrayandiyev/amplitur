...
<div class="row page-titles">
    <div class="col-md-8">
        <h3 class="text-themecolor">{{ __('resources.invoiceInformation.create') }}</h3>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ __('resources.invoiceInformation.create') }}</li>
        </ol>
    </div>
    <div class="col-md-4">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form id="inclusionsForm" method="post" action="{{ route('backend.invoiceInformation.store', []) }}" autocomplete="off">
                @csrf
                ...
                <div class="card-body row">
                    ...
                    <div class="form-group col-md-12">
                        <label class="form-control-label">{{ __('resources.invoiceInformation.model.description') }}</label>
                        <span class="text-danger">*</span>
