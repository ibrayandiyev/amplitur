...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form id="pageGroupForm" method="post" action="{{ route('backend.pages.groups.update', $pageGroup) }}" autocomplete="off">
                @csrf
                ...
                <div class="tab-content p-4">
                    <div class="tab-pane active" id="pt-br" role="tabpanel">
                        <div class="row">
                            <div class="form-group col-md-12 @if($errors->has('name')) has-danger @endif">
                                ...
                                <input type="text" class="form-control" name="name[pt-br]" value="{{ old('name.pt-br', $pageGroup->getTranslation('name', 'pt-br', false)) }}" />
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane" id="en" role="tabpanel">
                        <div class="row">
                            <div class="form-group col-md-12 @if($errors->has('name')) has-danger @endif">
                                ...
                                <input type="text" class="form-control" name="name[en]" value="{{ old('name.en', $pageGroup->getTranslation('name', 'en', false)) }}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-12 @if($errors->has('name')) has-danger @endif">
                            ...
                            <input type="text" class="form-control" name="name[es]" value="{{ old('name.es', $pageGroup->getTranslation('name', 'es', false)) }}" />
                        </div>
                    </div>
                </div>
                </div>
