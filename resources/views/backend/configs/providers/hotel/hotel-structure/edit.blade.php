...
<div class="row page-titles">
    <div class="col-md-5">
        <h3 class="text-themecolor">{{ __('resources.hotel-structure.edit') }}</h3>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ $hotelStructure->name }}</li>
        </ol>
    </div>
    <div class="col-md-7">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form id="hotelStructureForm" method="post" action="{{ route('backend.configs.providers.hotel.hotel-structure.update', $hotelStructure) }}" autocomplete="off">
                @csrf
                        ...
                        <div class="form-group col-md-12 @if($errors->has('name')) has-danger @endif">
                            ...
                            <div class="tab-content br-n pn">
                                <div id="hotel-structure-name-pt-br" class="tab-pane active">
                                    <input type="text" class="form-control" name="name[pt-br]" value="{{ old('name.pt-br', $hotelStructure->getTranslation('name', 'pt-br')) }}">
                                </div>
                                <div id="hotel-structure-name-en" class="tab-pane">
                                    <input type="text" class="form-control" name="name[en]" value="{{ old('name.en', $hotelStructure->getTranslation('name', 'en')) }}" required>
                                </div>
                                <div id="hotel-structure-name-es" class="tab-pane">
                                    <input type="text" class="form-control" name="name[es]" value="{{ old('name.es', $hotelStructure->getTranslation('name', 'es')) }}" required>
                                </div>
                            </div>
