...
<div class="row page-titles">
    <div class="col-md-5">
        <h3 class="text-themecolor">{{ __('resources.hotel-accommodation-structure.edit') }}</h3>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ $hotelAccommodationStructure->name }}</li>
        </ol>
    </div>
    <div class="col-md-7">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form id="hotelAccommodationStructureForm" method="post" action="{{ route('backend.configs.providers.hotel.accommodation-structure.update', $hotelAccommodationStructure) }}" autocomplete="off">
                @csrf
                        ...
                        <div class="form-group col-md-12 @if($errors->has('name')) has-danger @endif">
                            ...
                            <div class="tab-content br-n pn">
                                <div id="hotel-accommodation-structure-name-pt-br" class="tab-pane active">
                                    <input type="text" class="form-control" name="name[pt-br]" value="{{ old('name.pt-br', $hotelAccommodationStructure->getTranslation('name', 'pt-br')) }}">
                                </div>
                                <div id="hotel-accommodation-structure-name-en" class="tab-pane">
                                    <input type="text" class="form-control" name="name[en]" value="{{ old('name.en', $hotelAccommodationStructure->getTranslation('name', 'en')) }}" required>
                                </div>
                                <div id="hotel-accommodation-structure-name-es" class="tab-pane">
                                    <input type="text" class="form-control" name="name[es]" value="{{ old('name.es', $hotelAccommodationStructure->getTranslation('name', 'es')) }}" required>
                                </div>
                            </div>
