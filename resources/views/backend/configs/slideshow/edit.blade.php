...
<div class="row page-titles">
    <div class="col-md-6">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('backend.configs.slideshow.index') }}">Slideshow</a>
            </li>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form id="imagesForm" method="post" action="{{ route('backend.configs.slideshow.update', $image) }}" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 @if($errors->has('subtitle')) has-danger @endif">
                            ...
                            <input type="text" name="subtitle" class="form-control" value="{{ old('subtitle', $image->subtitle) }}" />
                        </div>
                        <div class="form-group col-md-3 @if($errors->has('language')) has-danger @endif">
                            ...
                            <select class="form-control" name="language">
                                ...
                                <option value="{{ App\Enums\Language::PORTUGUESE }}" @if(old('language', $image->language) == App\Enums\Language::PORTUGUESE) selected @endif>{{ __('resources.language.portuguese') }}</option>
                                <option value="{{ App\Enums\Language::ENGLISH }}" @if(old('language', $image->language) == App\Enums\Language::ENGLISH) selected @endif>{{ __('resources.language.english') }}</option>
                                <option value="{{ App\Enums\Language::SPANISH }}" @if(old('language', $image->language) == App\Enums\Language::SPANISH) selected @endif>{{ __('resources.language.spanish') }}</option>
                            </select>
                        </div>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('backend.images.destroy', $image) }}"  class="btn btn-danger delete pull-right">
