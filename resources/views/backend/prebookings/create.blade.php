...
<div class="row page-titles">
    <div class="col-md-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ __('resources.prebookings.create') }}</li>
        </ol>
    </div>
</div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4  @if($errors->has('country')) has-danger @endif">
                            ...
                            <select name="country" class="form-control">
                                ...
                                @foreach ($countries as $country)
                                    <option value="{{ $country->iso2 }}" @if (old('country')) selected @endif>{{ country($country->iso2) }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-4 @if($errors->has('phone')) has-danger @endif">
                            ...
                            <select class="form-control" name="responsible">
                                <option value="{{ \App\Enums\ResponsibleType::CLIENT }}" @if (old('responsible') == \App\Enums\ResponsibleType::CLIENT ) selected @endif>{{ __('resources.prebookings.model.responsibles.client') }}</option>
                                <option value="{{ \App\Enums\ResponsibleType::AGENCY }}" @if (old('responsible') == \App\Enums\ResponsibleType::AGENCY ) selected @endif>{{ __('resources.prebookings.model.responsibles.agency') }}</option>
                            </select>
                        </div>
                    </div>
                </div>
