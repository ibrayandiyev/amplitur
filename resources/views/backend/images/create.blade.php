...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form id="imagesForm" method="post" action="{{ route('backend.images.store') }}" enctype="multipart/form-data" autocomplete="off">
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-8">
                            ...
                            <select class="form-control select2" name="event_id"></select>
                        </div>
