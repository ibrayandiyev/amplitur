...
<div class="row page-titles">
    <div class="col-md-6">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('backend.images.index') }}">{{ __('resources.images.name-plural') }}</a>
            </li>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form id="imagesForm" method="post" action="{{ route('backend.images.update', $image) }}" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-8">
                            ...
                            <p>{{ mb_strtoupper($image->event->name) }}</p>
                        </div>
                        ...
                        <div class="form-group col-md-8">
                            ...
                            <select class="form-control select2" name="package_id">
                                <option value></option>
                                @foreach ($image->event->packages as $package)
                                    <option value="{{ $package->id }}" @if ($image->package_id == $package->id) selected @endif>{{ mb_strtoupper($package->extendedName) }}</option>
                                @endforeach
                            </select>
                        </div>
