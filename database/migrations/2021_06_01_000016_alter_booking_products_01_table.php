...
class AlterBookingProducts01Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('booking_products', function (Blueprint $table) {
            $table->dropForeign('booking_products_currency_origin_id_foreign');
            $table->dropForeign('booking_products_company_id_foreign');
