...
class AlterBookingPassengerAdditionals01Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('booking_passenger_additionals', function (Blueprint $table) {
            $table->dropForeign('booking_passenger_additionals_currency_origin_id_foreign');
            $table->dropForeign('booking_passenger_additionals_company_id_foreign');
