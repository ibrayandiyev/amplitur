...
class ShuttleRouteRepository extends Repository
{
    /**
     * @var Offer
     */
    ...
    public function __construct(ShuttleRoute $model)
    {
        $this->model = $model;
    }
     ...
     */
    public function setOffer(Offer $offer): ShuttleRouteRepository
    {
        $this->offer = $offer;
