...
class LongtripRouteRepository extends Repository
{
    /**
     * @var Offer
     */
    ...
    public function __construct(LongtripRoute $model)
    {
        $this->model = $model;
    }
     ...
     */
    public function setOffer(Offer $offer): LongtripRouteRepository
    {
        $this->offer = $offer;
