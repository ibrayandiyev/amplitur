...
class ProviderAirfareOffersController extends Controller
{
    ...
    public function createItem(Request $request, Provider $provider, Company $company, Offer $offer)
    {
        try {
            ...
            return view('backend.offers.types.airfare.items.create')
    ...
    public function storeItem(Request $request, Provider $provider, Company $company, Offer $offer)
    {
        try {
            ...
            return redirect()->route('backend.providers.companies.offers.edit', ['provider' => $provider, 'company' => $company, 'offer' => $offer, 'navigation' => 'itens'])->withSuccess(__('resources.airfare.created'));
        } catch (Exception $ex) {
            bugtracker()->notifyException($ex);
            return redirect()->route('backend.providers.companies.offers.airfare.createItem', ['provider' => $provider, 'company' => $company, 'offer' => $offer, 'navigation' => 'itens'])->withInput($attributes)->withError($ex->getMessage());
        }
    }
    ...
    public function editItem(Request $request, Provider $provider, Company $company, Offer $offer, Additional $additional)
    {
        try {
            ...
            return view('backend.offers.types.airfare.items.edit')
            ->with('provider', $provider)
                ->with('company', $company)
                ->with('offer', $offer)
    ...
    {
        try {
            return view('backend.offers.types.airfare.groups.create')
            ->with('provider', $provider)
                ->with('company', $company)
                ->with('offer', $offer);
        } catch (Exception $ex) {
    ...
    public function storeGroup(Request $request, Provider $provider, Company $company, Offer $offer)
    {
        try {
            ...
            bugtracker()->notifyException($ex);
            return redirect()->route('backend.providers.companies.offers.airfare.createGroup', ['provider' => $provider, 'company' => $company, 'offer' => $offer, 'navigation' => 'itens'])->withInput($attributes)->withError($ex->getMessage());
        }
    }
    ...
    public function editGroup(Request $request, Provider $provider, Company $company, Offer $offer, AdditionalGroup $additionalGroup)
    {
        try {
            ...
            return view('backend.offers.types.airfare.groups.edit')
            ->with('provider', $provider)
                ->with('company', $company)
                ->with('offer', $offer)
