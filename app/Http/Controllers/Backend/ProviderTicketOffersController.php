...
class ProviderTicketOffersController extends Controller
{
    ...
    public function createItem(Request $request, Provider $provider, Company $company, Offer $offer)
    {
        try {
            ...
            return view('backend.offers.types.ticket.items.create')
    ...
    public function storeItem(Request $request, Provider $provider, Company $company, Offer $offer)
    {
        try {
            ...
            return redirect()->route('backend.providers.companies.offers.edit', ['provider' => $provider, 'company' => $company, 'offer' => $offer, 'navigation' => 'itens'])->withSuccess(__('resources.ticket.created'));
        } catch (Exception $ex) {
            bugtracker()->notifyException($ex);
            return redirect()->route('backend.providers.companies.offers.ticket.createItem', ['provider' => $provider, 'company' => $company, 'offer' => $offer, 'navigation' => 'itens'])->withInput($attributes)->withError($ex->getMessage());
        }
    }
    ...
    public function editItem(Request $request, Provider $provider, Company $company, Offer $offer, Additional $additional)
    {
        try {
            ...
            return view('backend.offers.types.ticket.items.edit')
                ->with('provider', $provider)
                ->with('company', $company)
                ->with('offer', $offer)
    ...
    {
        try {
            return view('backend.offers.types.ticket.groups.create')
                ->with('provider', $provider)
                ->with('company', $company)
                ->with('offer', $offer);
        } catch (Exception $ex) {
    ...
    public function storeGroup(Request $request, Provider $provider, Company $company, Offer $offer)
    {
        try {
            ...
            bugtracker()->notifyException($ex);
            return redirect()->route('backend.providers.companies.offers.ticket.createGroup', ['provider' => $provider, 'company' => $company, 'offer' => $offer, 'navigation' => 'itens'])->withInput($attributes)->withError($ex->getMessage());
        }
    }
    ...
    public function editGroup(Request $request, Provider $provider, Company $company, Offer $offer, AdditionalGroup $additionalGroup)
    {
        try {
            ...
            return view('backend.offers.types.ticket.groups.edit')
            ->with('provider', $provider)
                ->with('company', $company)
                ->with('offer', $offer)
