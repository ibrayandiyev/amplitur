...
class ProviderTravelInsuranceOffersController extends Controller
{
    ...
    public function createItem(Request $request, Provider $provider, Company $company, Offer $offer)
    {
        try {
            ...
            return view('backend.offers.types.travel-insurance.items.create')
     ...
     * @return  [type]               [return description]
     */
    public function storeItem(Request $request, Provider $provider, Company $company, Offer $offer)
    {
        try {
            ...
            return redirect()->route('backend.providers.companies.offers.edit', ['provider' => $provider, 'company' => $company, 'offer' => $offer, 'navigation' => 'itens'])->withSuccess(__('resources.travel-insurance.created'));
        } catch (Exception $ex) {
            bugtracker()->notifyException($ex);
            return redirect()->route('backend.providers.companies.offers.travel-insurance.createItem', ['provider' => $provider, 'company' => $company, 'offer' => $offer, 'navigation' => 'itens'])->withInput($attributes)->withError($ex->getMessage());
        }
    }
    ...
    public function editItem(Request $request, Provider $provider, Company $company, Offer $offer, Additional $additional)
    {
        try {
            ...
            return view('backend.offers.types.travel-insurance.items.edit')
            ->with('provider', $provider)
                ->with('company', $company)
                ->with('offer', $offer)
     ...
     * @return  [type]               [return description]
     */
    public function updateItem(Request $request, Provider $provider, Company $company, Offer $offer, Additional $additional)
    {
        try {
            $attributes = $request->toArray();
    ...
    {
        try {
            return view('backend.offers.types.travel-insurance.groups.create')
            ->with('provider', $provider)
                ->with('company', $company)
                ->with('offer', $offer);
        } catch (Exception $ex) {
    ...
    public function storeGroup(Request $request, Provider $provider, Company $company, Offer $offer)
    {
        try {
            ...
            bugtracker()->notifyException($ex);
            return redirect()->route('backend.providers.companies.offers.travel-insurance.createGroup', ['provider' => $provider, 'company' => $company, 'offer' => $offer, 'navigation' => 'itens'])->withInput($attributes)->withError($ex->getMessage());
        }
    }
    ...
    public function editGroup(Request $request, Provider $provider, Company $company, Offer $offer, AdditionalGroup $additionalGroup)
    {
        try {
            ...
            return view('backend.offers.types.travel-insurance.groups.edit')
            ->with('provider', $provider)
                ->with('company', $company)
                ->with('offer', $offer)
